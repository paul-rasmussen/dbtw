...
public class BuildMySQLAdminEmpireDialog extends JFrame {
    //Static variables
    //Constants
    ...
    //Constructors
    public BuildMySQLAdminEmpireDialog() {
        init();
    }
    ...
    private void loadDefaults() {
        ...
        views.addElement("SESSION_STATUS");
        views.addElement("KEY_COLUMN_USAGE");
        views.addElement("PARAMETERS");
        views.addElement("REFERENTIAL_CONSTRAINTS");
        views.addElement("SCHEMATA");
        views.addElement("TABLESPACES");
        views.addElement("TABLE_CONSTRAINTS");
        views.addElement("VIEWS");
    }
    ...
    private void submitAction() {
      ...
      String className = "";
      String schema = "";
      out = new File(txtDest.getText(), ("MySQLDatabase.java"));
